const manualSections: Record<string, string[]> = {
  ...
  Interact: [
    ...
    '- examine desk/drawer/mirror/table/key/room.',
  ...
  Puzzle: [
    ...
    '- Unlocking the drawer gives you a headlamp and a notebook.',
    '',
    'Examples:',
    '- enter code 4312',
    '- use code 4312',
...
const commandHelpEntries: CommandHelpEntry[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      'Syntax: examine desk|drawer|mirror|table|key|room',
      'Examples:',
      '- examine desk',
      '- examine mirror',
      '- examine key',
  ...
  },
  {
    ...
    lines: [
      'USE HEADLAMP',
      'Turn on your headlamp to light the mansion.',
      'Syntax: use headlamp',
      'Example: use headlamp',
    ],
  },
  {
    keys: ['ai help'],
